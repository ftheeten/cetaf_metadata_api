...
class ESLoader():
    ...
    def load_current_institutions(self):
        ...
        for inst in q:
            ...
            resp = self.es_client.index(index=self.es_institutions, id=inst.uuid_institution_normalized, document=data)
            print(resp)
    ...
    def load_current_collections(self):
        ...
        for coll in q:
            ...
            resp = self.es_client.index(index=self.es_collections, id=coll.uuid_collection_normalized, document=data)
            print(resp)